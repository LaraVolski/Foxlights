...
# Phase 9 --> Phase 5
phase_key <- tibble(Phase = c("Phase1", "Phase2", "Phase3", "Phase4", "Phase5", "Phase6", "Phase7", "Phase8", "Phase9"), qPhase_New = c(1, 1, 2, 2, 3, 3, 4, 4, 5))
...
# The mult_format multiplies the coyote RAI by 35, so instead of looking at daily average RAI, we are looking at it per 5 week phase. If you want to take it to a 10 week phase, multiply it by 50. Idk why. 
...
multilines2 <-function (A, B, xscale = 24, linetype = c(1, 1), linecol = c("palegreen4", "darkorange4"), n.grid = 128, kmax = 3, adjust = 1,
                        ...) 
{
...
legend('top', c("Yes Foxlight", "No Foxlight"), col = c("palegreen4", "darkorange4"), lwd = 3, lty=c(1,1), bty='n')
```
