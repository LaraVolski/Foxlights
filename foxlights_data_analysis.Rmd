...
ggplot(subset(rai, Species == "CALA"), aes(x = Foxlight, y = RAI, fill = Foxlight)) +
 ...
 # geom_jitter() +
  labs(x ="Foxlight", y = "Relative Coyote Activity (detections/5 week Foxlight periods)") +
...
legend('top', c("Active Foxlight", "Inactive Foxlight"), col = c("cadetblue3", "antiquewhite3"), lty=c(1,1), bty='n')
```
