...
# plot for coyotes
multilines2(records.coyote.foxyes$Time.Sun, records.coyote.foxno$Time.Sun, main = "Daily Acitivty Patterns of Coyotes")
legend('top', c("Yes Foxlight", "No Foxlight"), col = c("yellow", "orange"), lty=c(1,1), bty='n')
