...
ggplot(subset(rai, Species == "CALA"), aes(x = Foxlight, y = RAI, fill = Foxlight)) +
 ...
 # geom_jitter() +
  ...
  scale_fill_manual(values=c("tomato2", "palegreen4")) +
...
# plot for coyotes
multilines2(records.coyote.foxyes$Time.Sun, records.coyote.foxno$Time.Sun, col = c("palegreen4", "tomato2"))
legend('top', c("Yes Foxlight", "No Foxlight"), col = c("green", "red"), lty=c(1,1), bty='n')
