...
ggplot(subset(rai, Species == "CALA"), aes(x = Foxlight, y = RAI, fill = Foxlight)) +
 ...
 # geom_jitter() +
  labs(x ="Foxlight", y = "Relative Coyote Activity (detections/Foxlight period)") +
...
legend('top', c("Active Foxlight", "Inactive Foxlight"), col = c("cadetblue3", "antiquewhite3"), lwd = 3, lty=c(1,1), bty='n')
```
