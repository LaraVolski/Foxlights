...
multilines2 <-function (A, B, xscale = 24, linetype = c(1, 1), linecol = c("palegreen4", 
                                                                           "tomato2"), n.grid = 128, kmax = 3, adjust = 1, 
                        ...) 
{
...
Coyotes (need help changing the color of this graph!)
```{r q4.graph}
# plot for coyotes
multilines2(records.coyote.foxyes$Time.Sun, records.coyote.foxno$Time.Sun, col = c("antiquewhite1", "cadetblue1"))
legend('top', c("Yes Foxlight", "No Foxlight"), col = c("antiquewhite1", "cadetblue1"), lty=c(1,1), bty='n')
```
