...
AIC = 424.4
```{r}
fit8 <- glmer.nb(Detections ~ Foxlight * rugged25.clean + offset(log(Operation)) + (1|Camera), data = subset(rai, Species == "CALA"), control=glmerControl(optimizer="bobyqa"), print(fit8, digits = 3))
summary(fit8)
vif(fit8)
```
